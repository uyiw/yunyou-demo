<template>
  <div class="common-hotel-item" :style="isEnd?{bodderBottom:'none'}:{}" @click="goToDetail(hotelItem.id)">
    <img :src="hotelItem.imgs" class="common-hotel-item-img"/>
...
.common-hotel-item{
    ...
    .common-hotel-item-img{
        width:240px;
        height:160px;
    }
    .common-hotel-item-right{
        width:419px;
        display:flex;
        flex-direction:column;
        .common-hotel-item-right-name{
            height:50px;
            font-size:36px;
        ...
        .common-hotel-item-right-star{
            width:100%;
            display:flex;
            align-items:center;
            margin-top:2px;
            margin-bottom:2px;
            .common-hotel-item-right-star-title{
                height:42px;
                font-size:30px;
                font-family:PingFangSC-Regular,PingFang SC;
                font-weight:400;
                color:rgba(113,182,48,1);
                line-height:42px;
                margin-right:10px;
            }
            .common-hotel-item-right-star-number{
                margin-left:32px;
                height:40px;
                font-size:28px;
                font-family:PingFangSC-Regular,PingFang SC;
